...
#     (15, 6), (15, 3), (12, 3), (9, 3), (6, 3), (3, 3) ]
    ...
    path = [(27, 51), (27, 50), (27, 49), (27, 48), (27, 47), (27, 46), (27, 45), (27, 44), (27, 43), (27, 42),
...
#             (5, 2), (5, 1), (4, 1), (3, 1), (2, 1), (1, 1)]
    ...
    while running:
        ...
        for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1), (-1, -1), (-1, 1), (1, -1),
            ...
            if 0 <= nx < np_maze.shape[0] and 0 <= ny < np_maze.shape[1] and np_maze[robot_position[0],robot_position[1]] != 0:
