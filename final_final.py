...
class VisibilityMap:
    ...
    def generate_repulsion_field(self, target_position):
        ...
        distance_field[target_position] = 0

        # make all 8 cells around the target cell with attraction field to 0
        for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1)]:
            nx, ny = target_position[0] + dx, target_position[1] + dy
            if 0 <= nx < self.grid_size[0] and 0 <= ny < self.grid_size[1]:
                distance_field[nx, ny] = 0
...
#     path = [ (27, 51), (27, 48), (27, 45), (27, 42), (24, 42), (24, 45), (21, 45), (21, 48),
...
#     (15, 6), (15, 3), (12, 3), (9, 3), (6, 3), (3, 3) ]
    ...
    # path = [(27, 49), (27, 48), (27, 47), (27, 46), (27, 45), (27, 44), (27, 43), (27, 42),
    # (26, 42), (25, 42), (24, 42), (24, 43), (24, 44), (24, 45), (23, 45), (22, 45), (21, 45), (21, 46),
    # (21, 47), (21, 48), (21, 49), (21, 50), (21, 51), (20, 51), (19, 51), (18, 51), (17, 51), (16, 51),
    # (15, 51), (14, 51), (13, 51), (12, 51), (11, 51), (10, 51), (9, 51), (9, 52), (9, 53), (9, 54),
    # (8, 54), (7, 54), (6, 54), (5, 54), (4, 54), (3, 54), (3, 53), (3, 52), (3, 51), (3, 50),
    # (3, 49), (3, 48), (3, 47), (3, 46), (3, 45), (3, 44), (3, 43), (3, 42), (3, 41), (3, 40),
    # (3, 39), (3, 38), (3, 37), (3, 36), (3, 35), (3, 34), (3, 33), (3, 32), (3, 31), (3, 30),
    # (3, 29), (3, 28), (3, 27), (3, 26), (3, 25), (3, 24), (3, 23), (3, 22), (3, 21), (4, 21),
    # (5, 21), (6, 21), (7, 21), (8, 21), (9, 21), (9, 22), (9, 23), (9, 24), (10, 24), (11, 24),
    # (12, 24), (13, 24), (14, 24), (15, 24), (16, 24), (17, 24), (18, 24), (19, 24), (20, 24), (21, 24),
    # (22, 24), (23, 24), (24, 24), (25, 24), (26, 24), (27, 24), (27, 23), (27, 22), (27, 21), (27, 20),
    # (27, 19), (27, 18), (27, 17), (27, 16), (27, 15), (27, 14), (27, 13), (27, 12), (27, 11), (27, 10),
    # (27, 9), (27, 8), (27, 7), (27, 6), (26, 6), (25, 6), (24, 6), (23, 6), (22, 6), (21, 6),
    # (21, 7), (21, 8), (21, 9), (21, 10), (21, 11), (21, 12), (20, 12), (19, 12), (18, 12), (17, 12),
    # (16, 12), (15, 12), (15, 11), (15, 10), (15, 9), (15, 8), (15, 7), (15, 6), (15, 5), (15, 4),
    # (15, 3), (14, 3), (13, 3), (12, 3), (11, 3), (10, 3), (9, 3), (8, 3), (7, 3), (6, 3),
    # (5, 3), (4, 3), (3, 3)]

    path = [(9, 14), (8, 14), (8, 15), (7, 15), (7, 16), (7, 17), (6, 17),
    ...
    # path = [(8, 14), (8, 15), (7, 15), (7, 16), (7, 17), (6, 17),
    #         (5, 17), (4, 17), (3, 17), (3, 18), (2, 18), (1, 18), (1, 17), (1, 16), (1, 15), (1, 14), (1, 13), (1, 12),
    #         (1, 11), (1, 10), (1, 9), (1, 8), (1, 7), (2, 7), (3, 7), (3, 8), (5, 8), (6, 8), (7, 8), (8, 8), (9, 8),
    #         (9, 7), (9, 6), (9, 5), (9, 4), (9, 3), (9, 2), (8, 2), (7, 2), (7, 3), (7, 4), (6, 4), (5, 4), (5, 3),
    #         (5, 2), (5, 1), (4, 1), (3, 1), (2, 1), (1, 1)]
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                # check first if the robot has target in proximity of the 2nd cell and it is in the highest total field
                running = False
        ...
        if path_index < len(path):
            ...
            # instead of circle add an image at path /target.png
            # target_image = pygame.image.load('terminator.jpg')
            target_image = pygame.image.load('wc.jpg')
            target_image = pygame.transform.scale(target_image, (GRID_SIZE, GRID_SIZE))
            # robot_path[-2][1] * GRID_SIZE, robot_path[-2][0] * GRID_SIZE)
            screen.blit(target_image, (target_pos[1] * GRID_SIZE, target_pos[0] * GRID_SIZE))
        ...
        repulsion_field = visibility_map.generate_repulsion_field(path[path_index])
        attraction_field = compute_attraction_field(np_maze, path[path_index])
       

        a,b =1,1 # a is the weight of attraction field and b is the weight of repulsion field
        ...
        max_field = a * attraction_field[robot_position[0],robot_position[1]] + b * repulsion_field[robot_position[0],robot_position[1]]
        max_coordinate = robot_position
        ...
        for dx, dy in [(-1, 0), (1, 0), (0, -1), (0, 1), (-1, -1), (-1, 1), (1, -1),
            ...
            if 0 <= nx < np_maze.shape[0] and 0 <= ny < np_maze.shape[1] and np_maze[nx,ny] != 0:
                # intial_field = a * attraction_field[robot_position[0],robot_position[1]] + b * repulsion_field[robot_position[0],robot_position[1]]
                total_field = a * attraction_field[nx, ny] + b * repulsion_field[nx, ny]
                if max_field < total_field:
                    max_field = total_field
                    max_coordinate = (nx,ny)
        
        new_position = max_coordinate
...
#         robot_path.append(new_position)
    ...
    # render a red line to show the path of the robot
        for i in range(len(robot_path)-1):
            if i + 1 < len(robot_path):
                start_point = (robot_path[i][1] * GRID_SIZE + GRID_SIZE // 2, robot_path[i][0] * GRID_SIZE + GRID_SIZE // 2)
                end_point = (robot_path[i + 1][1] * GRID_SIZE + GRID_SIZE // 2, robot_path[i + 1][0] * GRID_SIZE + GRID_SIZE // 2)
    ...
    # now render a robot in the maze with circle which follows target path but 2 frames later then it moves along the path
        for i in range(len(robot_path)-1):
            if i + 1 < len(robot_path):
                ...
                # instead of circle add an image at path /robot.png
                # robot_image = pygame.image.load('robot.jpg')
                robot_image = pygame.image.load('bcci.jpeg')
                robot_image = pygame.transform.scale(robot_image, (GRID_SIZE, GRID_SIZE))
                # screen.blit(robot_image, (robot_path[-2][1] * GRID_SIZE + GRID_SIZE // 2, robot_path[-2][0] * GRID_SIZE + GRID_SIZE // 2))
                # make it such that it is center of the image coincides with the center of the cell
                screen.blit(robot_image, (robot_path[-1][1] * GRID_SIZE, robot_path[-1][0] * GRID_SIZE))
...
# TODO: 
#[DONE] 2. Add penalizing field
#[DONE]  1. Add the robot line to the maze
#[DONE]  3. Add robot and target photo\
# 4. Add the robot path continuation & fixing error(DONE)